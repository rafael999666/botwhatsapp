...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5516988466655:+55 16 98846-6655\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
const config = {
    XBOT: 'BOT EREN', 
    instagram: 'Por enquanto to sem insta', 
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '❬❗❭ COMANDO EXCLUSIVO PARA O BARDOKILL.❬❗❭ ',
					ownerB: '❬❗❭  COMANDO EXCLUSIVO PARA O BARDOKILL.❬❗❭  ',
					admin: ' ❬ ⚠️ ❭ KKK MEMBRO COMUM TENTANDO USAR COMANDO DOS ADEMAR🤣 ❬ ⚠️ ❭ ',
...
case 'lofi':
            ...
            case 'criador':
            case 'bardokill':
                  client.sendMessage(from, {displayname: "bardokill", vcard: vcard}, MessageType.contact, { quoted: mek})
